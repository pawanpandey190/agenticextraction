    ...
    <div className="space-y-8 pb-12">
      ...
      {!showDocuments && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <GlassCard className={`flex flex-col items-center justify-center p-8 text-center border-slate-200 bg-white shadow-sm transition-all hover:bg-slate-50/50 ${!result.passport?.is_passport ? 'border-red-100 bg-red-50/30' : ''}`}>
            <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-6">Identity Check</p>
            <div className="relative w-32 h-32 flex items-center justify-center">
              {result.passport?.is_passport ? (
                <>
                ...
                <div className="flex flex-col items-center justify-center text-red-500 gap-2">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-tight leading-tight italic">
                    The uploaded document <br /> is not a passport
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mt-1">
                  {result.education && result.education.french_equivalent_grade_0_20 !== null
            ...
            <div className="p-6 space-y-4">
              <p className="text-sm text-slate-400 mb-4">
                {result.passport?.is_passport
                  ...
                  : "The document provided is not a valid passport. Please verify the identity manually and correct the details before proceeding."}
              </p>
