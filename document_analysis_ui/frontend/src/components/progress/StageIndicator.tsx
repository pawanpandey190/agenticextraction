        ...
        return (
          <div key={stage} className="flex items-center space-x-3">
            ...
            <div className={`
              ...
              ${isDone ? 'bg-emerald-50 border border-emerald-100' : isActive ? 'bg-brand-primary/10 border border-brand-primary/20' : 'bg-slate-50 border border-slate-100'}
            `}>
              {isDone ? (
                ...
                <svg className="w-5 h-5 text-brand-primary animate-spin" fill="none" viewBox="0 0 24 24">
            ...
            <span className={`
              ...
              ${isDone ? 'text-emerald-600' : isActive ? 'text-brand-primary' : 'text-slate-300'}
            `}>
